...
const PlanosIniciaisPage = () => {
  ...
  const planData = {
    ...
    period: "por mês",
    features: [
      "Acesso a +40 ferramentas premium",
      "Suporte via WhatsApp", 
      "Programa de afiliados ativo",
      "Ideal para uso leve e testes",
      "Sem fidelidade",
      "Acesso imediato"
    ],
  ...
  const benefitsData = [
    {
      ...
      description: "Todas as ferramentas essenciais"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Ganhe com indicações"
    },
    {
      icon: Unlock,
      title: "Acesso ilimitado, sem travas",
      description: "Use quando precisar"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className={`transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto mb-6">
                Plano ideal para quem busca <strong>economia e acesso essencial</strong>. 
            ...
            <div className={`transition-all duration-1000 delay-300 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="bg-gradient-to-br from-[#9333ea]/10 via-transparent to-[#7e22ce]/10 backdrop-blur-xl border border-[#9333ea]/30 rounded-2xl p-8 shadow-2xl shadow-[#9333ea]/20">
                <p className="text-lg text-gray-300 leading-relaxed">
                  Com base nas suas respostas, identificamos que você busca uma solução <strong>econômica e prática</strong>. 
                  Este plano oferece acesso às ferramentas essenciais com o melhor custo-benefício, 
                  ideal para quem quer testar a plataforma ou faz uso mais leve das funcionalidades.
                </p>
              </div>
            </div>
          </div>
...
export default PlanosIniciaisPage;
