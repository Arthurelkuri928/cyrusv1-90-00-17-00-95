...
import { Check, Crown, Sparkles, Zap, Shield, DollarSign, Unlock } from "lucide-react";
import SinglePlanTable from "@/components/plans/SinglePlanTable";

const PlanosPremiumPage = () => {
  ...
  const planData = {
    ...
    period: "por ano",
    features: [
      "Acesso total e ilimitado a +40 ferramentas",
      "Suporte VIP e atendimento prioritário no WhatsApp", 
      "Participação no programa de afiliados com melhores condições",
      "Benefícios exclusivos, estabilidade e segurança total",
  ...
  const benefitsData = [
    {
      ...
      description: "Máxima performance e liberdade"
    },
    {
      icon: Shield,
    ...
    {
      icon: DollarSign,
      title: "Programa de afiliados premium",
      description: "Melhores condições de ganho"
    },
    {
      icon: Unlock,
      title: "Acesso ilimitado, sem travas",
      description: "Liberdade total para usar tudo"
    }
  ];
            ...
            <div className={`transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="flex justify-center mb-6">
                <div className="bg-gradient-to-r from-[#9333ea] to-[#7e22ce] text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2">
                  ...
                  Plano Mais Completo da Plataforma
                </div>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto mb-6">
                Plano ideal para quem busca <strong>liberdade total para usar sem limites</strong>. 
            ...
            <div className={`transition-all duration-1000 delay-300 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="bg-gradient-to-br from-[#9333ea]/10 via-transparent to-[#7e22ce]/10 backdrop-blur-xl border border-[#9333ea]/30 rounded-2xl p-8 shadow-2xl shadow-[#9333ea]/20">
                <p className="text-lg text-gray-300 leading-relaxed">
                  Com base nas suas respostas, identificamos que você precisa do <strong>máximo em liberdade e recursos</strong>. 
                  Este plano oferece acesso irrestrito a todas as ferramentas, suporte VIP e benefícios exclusivos. 
                  É o plano definitivo para quem quer tudo sem limitações.
                </p>
              </div>
            </div>
          </div>
...
export default PlanosPremiumPage;
