...
const MarketPainSection = ({ addSectionRef }: { addSectionRef: (index: number) => (el: HTMLElement | null) => void }) => {
        ...
        {isMobile ? (
          ...
          <div className="flex flex-col space-y-5 mb-10">
            {problems.map((problem, index) => (
              ...
              >
                <div className="text-[#FF4B4B] mr-3 flex-shrink-0 mt-0.5 text-xl">×</div>
